...
const WhyUs = () => {
  ...
  return (
    <div className="py-24 dark:bg-dark-secondary">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-2 text-center">
          {whyUsData.map((data, index) => (
            ...
            >
              <div className="text-8xl  text-light-primary dark:text-dark-primary mb-4">
                {data.icon}
              </div>
              <h3 className="text-2xl font-bold font-heading mb-2 text-gray-800 dark:text-white">
                {data.heading}
              </h3>
              <p className="text-gray-600 text-base font-body dark:text-gray-300">
                {data.info}
              </p>
            </div>
          ))}
